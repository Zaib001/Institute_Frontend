    ...
    <section className="px-8 py-16 bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        >
          ...
          <p className="mt-2">We would love to hear from you. Please reach out with any questions or feedback!</p>
        </motion.div>
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl font-bold text-red-700 mb-4">Contact Information</h2>
